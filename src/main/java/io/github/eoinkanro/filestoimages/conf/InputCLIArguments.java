...
public final class InputCLIArguments {
    ...
    public static final InputCLIArgument<String> FILES_PATH = new InputCLIArgument<>("fp", "filesPath", true, "Path to folder with files that will be transformed", "resultFiles" + TimeUtils.getCurrentTime());
    ...
    public static final InputCLIArgument<String> VIDEOS_PATH = new InputCLIArgument<>("vp", "videosPath", true, "Path to folder with videos that will be transformed", "resultVideos" + TimeUtils.getCurrentTime());
    ...
    public static final InputCLIArgument<String> IMAGES_PATH = new InputCLIArgument<>("ip", "imagesPath", true, "Path to folder with images that will be transformed", "resultImages" + TimeUtils.getCurrentTime());
